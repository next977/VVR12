    ...
    : QWidget(parent)
{
   ...
   connect(visibleTimer, SIGNAL(timeout()), this, SLOT(slot_visible())); //Timer
   visibleTimer->start();
...
void QGauge::slot_visible()
{
    if(global::qgauge_visible==true)
    {
        this->show();
    }
    else
...
void QGauge::setValue1(double value)
{
    //setMinValue(0);
   // setMaxValue(130);
   // setDigitCount(5);
...
void QGauge::setValue1(int value)
{
